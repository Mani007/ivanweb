  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
      ...
      <div className="space-y-8 md:grid md:grid-cols-2 lg:grid-cols-3 md:gap-12 md:space-y-0">
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold text-[#00df9a]">Marketing</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold text-[#00df9a]">Legal</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold text-[#00df9a]">Business Automation</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold text-[#00df9a]">Finance</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold  text-[#00df9a]">Enterprise Design</h3>
          ...
          <div>
              ...
              <h3 className="mb-2 text-xl font-bold text-[#00df9a]">Operations</h3>
