...
function Contentprimary() {
  ...
  <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="max-w-screen-lg text-slate-300 sm:text-lg dark:text-gray-400">
          <h2 className="mb-4 text-4xl tracking-tight font-bold text-slate-200 dark:text-white">Powering innovation at <span className="font-extrabold">200,000+</span> companies worldwide</h2>
          ...
          <a href="#" className="inline-flex items-center font-medium text-green-400  hover:text-primary-800 dark:text-primary-500 dark:hover:text-primary-700">
              Learn more
