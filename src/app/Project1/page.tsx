...
function page() {
  return (
    ...
    <div className=" relative flex bg-slate-900 py-28 items-center justify-center flex-col ">
        ...
        <iframe className=' w-screen sm:max-w-2xl  min-h-full' width="560" height="315" src="https://www.youtube.com/embed/2ImfsIPUQsQ?si=r8B518ntpvrSD5K3" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
        </div>
        <div className="mt-16 px-20 text-start">
